...
Author:
    ...
    Chuck Bauman 03-Jun-1993


Revision History:

    Modified SP_VIRTUAL_BASE and SERIAL2_PHYSICAL_BASE to use COM2 17-Aug-1993
...
//
// BUGBUG Temporarily until next drop when registry support will be included.
//
extern PVOID HalpEisaControlBase;
#define  COM1_PORT               0x3f8
#define  COM2_PORT               0x2f8                          // IBMCDB
#define  SP_VIRTUAL_BASE         ((PSZ) HalpEisaControlBase+COM2_PORT)// IBMCDB
#define  SERIAL2_PHYSICAL_BASE   EISA_CONTROL_PHYSICAL_BASE+COM2_PORT // IBMCDB
