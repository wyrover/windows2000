...
extern HWND g_hDlg;             // nonzero if page is up
...
void NEAR PASCAL LookPrev_Draw(HWND hWnd, HDC hdc)
{
    ...
    hfontOld = SelectObject(hdc, g_fonts[FONT_CAPTION].hfont);
...
LRESULT CALLBACK  LookPreviewWndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    PAINTSTRUCT ps;
    DWORD dw;
    int iEl;
