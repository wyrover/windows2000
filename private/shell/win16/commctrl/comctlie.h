...
#ifndef _INC_COMCTLIE
#define _INC_COMCTLIE
...
} INITCOMMONCONTROLSEX, FAR *LPINITCOMMONCONTROLSEX;
...
#define CDDS_PREERASE           0x000000003
#define CDDS_POSTERASE          0x000000004
...
#define ILC_COLOR       0x0000      // use default
...
#else
#define TOOLBARCLASSNAME "IE_ToolbarWindow"
#endif
...
#define TBSTYLE_DROPPABLE       0x4000
...
//#ifdef _WIN32
#if 1   // use the 32-bit notification scheme for IE
...
#define TBN_DROPDOWN        0x020c              /* ;Internal */
                                /* ;Internal */
#endif
...
#else
#define REBARCLASSNAME          "ie_ReBarWindow"
#endif
...
#else
#define TOOLTIPS_CLASS "ie_tooltips_class"
#endif
...
#define TTF_WIDISHWND            0x0001  // ;Internal
...
#else
#define STATUSCLASSNAME "ie_msctls_statusbar"
#endif
...
WINCOMMCTRLAPI HWND WINAPI CreateHeaderWindow(LONG style, LPCSTR lpszText, HWND hwndParent, UINT wID); /* ;Internal */
                                            /* ;Internal */
#define HEADERCLASSNAME "ie_msctls_headerbar"                       /* ;Internal */
                                            /* ;Internal */
...
#else
#define TRACKBAR_CLASS          "ie_msctls_trackbar"
#endif
...
#define DRAGLISTMSGSTRING "ie_commctrl_DragListMsg"
...
#else
#define UPDOWN_CLASS "ie_msctls_updown"
#endif
...
#else
#define PROGRESS_CLASS "ie_msctls_progress"
#endif
...
#else
#define HOTKEY_CLASS "ie_msctls_hotkey"
#endif
#endif /* NOHOTKEY */
...
#else
#define WC_LISTVIEW         "IE_SysListView"
#endif
...
#else
#define WC_TREEVIEW     "IE_SysTreeView"
#endif
...
#else
#define WC_TABCONTROL         "IE_SysTabControl"
#endif
