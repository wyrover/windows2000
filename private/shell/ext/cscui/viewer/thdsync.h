...
/*  File: thdsync.h
    ...
    10/13/98    Removed unused code from compilation.                BrianAu
*/
///////////////////////////////////////////////////////////////////////////////
#ifndef _WINDOWS_
#   include <windows.h>
...
{
    public:
        explicit AutoLockMutex(HANDLE hMutex, DWORD dwTimeout = INFINITE)
            : m_hMutex(hMutex) { Wait(dwTimeout); }

        explicit AutoLockMutex(CMutex& mutex, DWORD dwTimeout = INFINITE)
