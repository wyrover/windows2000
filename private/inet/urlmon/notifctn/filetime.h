...
#define ONE_DAY_IN_FILETIME     (ONE_SECOND_IN_FILETIME * 60i64 * 60i64 * 24i64)
#else

// This is Monday, January 1, 1601 at 12:00:00 am
#define MIN_FILETIME            0LL

// This is Thursday, September 14, 30828 at 2:48:05 am
#define MAX_FILETIME            0x7FFFFFFFFFFFFFFFLL

//  For clarity since FILETIME is expressed as 100-nanosecond intervals
#define ONE_SECOND_IN_FILETIME  10000000LL
#define ONE_MSEC_IN_FILEITME    10000LL
#define ONE_MINUTE_IN_FILETIME  (ONE_SECOND_IN_FILETIME * 60LL)
#define ONE_DAY_IN_FILETIME     (ONE_SECOND_IN_FILETIME * 60LL * 60LL * 24LL)
#endif /* unix */
