...
#pragma section(".CRT$XIA", long)
#pragma data_seg(".CRT$XIA")
_PVFV __xi_a[] = { NULL };

#pragma section(".CRT$XIZ", long)
#pragma data_seg(".CRT$XIZ")
_PVFV __xi_z[] = { NULL };

#pragma section(".CRT$XCA", long)
#pragma data_seg(".CRT$XCA")
EXTERN_C _PVFV __xc_a[] = { NULL };

#pragma section(".CRT$XCZ", long)
#pragma data_seg(".CRT$XCZ")
EXTERN_C _PVFV __xc_z[] = { NULL };

#pragma section(".CRT$XPA", long)
#pragma data_seg(".CRT$XPA")
_PVFV __xp_a[] = { NULL };

#pragma section(".CRT$XPZ", long)
