...
TCHAR *vrgsz [CSTRINGS+1];  /* Strings loaded in from the resource file. */
...
/* ReOpen Buffers. */
TCHAR vszOFSFileSpec [CFILE][CCHFILESPECMAX] ;
...
TCHAR vszFileSpec   [CCHFILESPECMAX];   /* Name of original file. */
TCHAR vszFilterSpec [CCHFILTERMAX];     /* Filter string for File Open */
TCHAR vszCustFilterSpec [CCHFILTERMAX];/* custom Filter string for File Open */
